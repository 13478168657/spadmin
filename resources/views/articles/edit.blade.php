                            ...
                            <table class="table table-condensed table-add">
                                ...
                                <tr>
                                    ...
                                    <td style="width:90%;">                                                                                      <input type="file" name="thumbPic" class="" id="">
                                        ...
                                        @if($article->thumbPic)
                                        <div class="img_span">
                                            <img class="img" src="{{env('IMG_URL').'/images/uploads/thumb/'.$article->thumbPic}}" style="width:80px;height:80px;margin-left:8px;"><span onclick="delImgUrl(this);" class="image_icon"></span>
                                        </div>
                                        @endif
